...
df1$PROVEDOR               <- abjutils::rm_accent(df1$PROVEDOR              ) 
...
df1$FACILIDADEEXATAS       <- abjutils::rm_accent(df1$FACILIDADEEXATAS      ) 
df1$OPINIAOPERIODOSREMOTOS <- abjutils::rm_accent(df1$OPINIAOPERIODOSREMOTOS) 
